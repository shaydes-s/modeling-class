...
//Last modified: Wed, Aug 30, 2023 07:42:17 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "E9D43F17-46D3-2880-1E03-298626681281";
createNode transform -s -n "persp";
	rename -uid "EEBF97F6-435C-5361-FBBC-0F85BE2A4FBB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.28763462511496 5.0453993453415507 7.404724995615779 ;
	setAttr ".r" -type "double3" -16.538352730372331 6179.3999999994776 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4A494B0A-46D3-9474-31BA-D18DCFC7EAC6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.5176831290121591;
